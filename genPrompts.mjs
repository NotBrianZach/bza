export default {
  genPromptChunkSummary: (title, synopsis, rollingSummary, excerpt, articleType prependList,appendList) =>
  ...
  genPromptRollingSummary: (title, synopsis, rollingSummary, excerpt, articleType, prependList, appendList) =>
  ...
  genPromptQuizGrade: (title, synopsis, excerpt, articleType, studentAnswers) => {
    switch (articleType) {
      // case "dnd":
